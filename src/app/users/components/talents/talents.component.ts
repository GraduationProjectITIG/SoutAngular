...
export class TalentsComponent implements OnInit {
  ...
  constructor(private translate: TranslateService,private fireService: FireService, private domSanitizer: DomSanitizer, private usrInfo: UserInfoService, private firestore: AngularFirestore, private postsService: PostsService, private route: Router, private locale: LocalizationService) {
